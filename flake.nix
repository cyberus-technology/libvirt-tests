{
  ...
  inputs = {
    ...
    # libvirt.url = "git+file:/home/skober/repos/libvirt?submodules=1";
    libvirt.url = "git+ssh://git@gitlab.cyberus-technology.de/shertrampf/libvirt.git?ref=migration-statistics-non-blocking-debugging&submodules=1";
    ...
    cloud-hypervisor.url = "github:phip1611/cloud-hypervisor?ref=poc-migration-statistics";
